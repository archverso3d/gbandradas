import { Question, Module, Belt } from '../types/quiz';
...
export const QUESTIONS: Question[] = [
    ...
    {
        id: 'f7',
        text: 'O atleta A aplica um triângulo. O atleta B coloca a mão por dentro da calça de B para defender. Qual a punição?',
